...
- description: развернутое описание мероприятия, переписанное другими словами (опционально). Перепиши текст поста своими словами, сохраняя всю важную информацию, но делая описание более структурированным и читаемым. Не сокращай до одного предложения - сохрани все детали из оригинального текста.
