        ...
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
          <div className="text-center mb-4">
            ...
            <p className="text-gray-600 mb-6">
              ...
              <br />
              <strong>Введите пароль 2FA</strong> для завершения авторизации.
              <br />
              <br />
              <span className="text-sm text-gray-500">
                💡 Это пароль двухфакторной аутентификации Telegram, который вы установили в настройках безопасности.
                <br />
                💡 Если вы забыли пароль, его можно сбросить в настройках Telegram.
              </span>
            </p>
          </div>
